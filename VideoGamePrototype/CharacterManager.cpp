...
CharacterManager::CharacterManager(const Rectf& playfield)
	...
	, m_Player{ Character{m_Playfield, m_PlayerFillColor, m_PlayerOutlineColor} }
{
...
void CharacterManager::CreateEnemy(int amount)
{
	for (int index{ 0 }; index < amount; ++index) {
		m_pEnemies.emplace_back(new Character{ m_Playfield, m_EnemyFillColor, m_EnemyOutlineColor });
	}
}
